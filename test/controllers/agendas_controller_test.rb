...
class AgendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post agendas_url, params: { agenda: { available: @agenda.available, patient_id: @agenda.patient_id, taken: @agenda.taken } }
    end
  ...
  test "should update agenda" do
    patch agenda_url(@agenda), params: { agenda: { available: @agenda.available, patient_id: @agenda.patient_id, taken: @agenda.taken } }
